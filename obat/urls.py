...
urlpatterns = [
    ...
    # Fungsi Obat
    path('create_f_obat/', views.create_f_obat, name='create_f_obat'),
    path('f_obat_list/', views.obat_f_list, name='f_obat_list'),
    re_path(r'^(?P<nof_obat>\d+)/update_f_obat/$', views.update_f_obat, name="update_f_obat"),
    re_path(r'^(?P<nof_obat>\d+)/delete_f_obat/$', views.delete_f_obat, name="delete_f_obat"),
]
